    ...
    <body>
        <header>
            ...
            <nav class="menu">
                ...
                <ul>
                    ...
                    <li><a href="EmergenciasActuales.jsp">Reporte de Evento</a>

                    </li>  
                    <li><a href="MaterialFaltante.jsp">Reporte de Mantenimiento (interacción)</a>

                    </li>
                    <li><a href="Especialistas.jsp">Asignar Ingeniero</a>
        ...
        <section class="principal">
            <section class="bannerM">
                <img src="IMAGENES/farmacos.jpg" alt="">
            ...
            <div id="aparece" style="align-items: center;">
                <a class="btn-floating btn tooltipped btn-large waves-effect waves-light black" data-position="top" data-tooltip="Agregar Material Sobrante" onclick="divAparece()"><i class="material-icons">add</i></a>
            </div>
            <div id="caja">
                <h1 style="text-align: center;color: #ffffff;">Registra el Material Sobrante</h1>
