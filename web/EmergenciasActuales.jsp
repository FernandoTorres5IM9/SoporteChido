    ...
    <body>
        ...
        <section class="principal">
            ...
            <div id="aparece" style="align-items: center;">
                <a class="btn-floating btn tooltipped btn-large waves-effect waves-light black" data-position="top" data-tooltip="Agregar Reporte" onclick="divAparece()"><i class="material-icons">add</i></a>
            </div>
            <div id="caja">
